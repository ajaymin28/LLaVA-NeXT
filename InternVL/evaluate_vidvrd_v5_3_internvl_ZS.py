...
if __name__=="__main__":
    ...
    with open('/home/jbhol/dso/gits/Video-LLaVA/prompts.pkl', 'rb') as handle:
        ...
        defaultPrompt = b["v13_prompt_vidvrd_withIds"]
    ...
    for val_id_idx, video_id in enumerate(val_ids):
        ...
        for frame_block_index, overall_annot in enumerate(subset_samples):
            ...
            outputs = pre_clean_prediction_data_onevision_v7(outputs_unclean["triplets"])
            ...
            # Block_GT_triplets_woids = Block_GT_Triplets
            ...
            try:
                ...
                print(f"error removing ids {e} {outputs}, {Block_GT_Triplets}")
                pass
