...
class TCSLoader(object):
    ...
    def __call__(self, fn, image_type='image', max_num_frames=-1, min_num_frames=8, sample='rand', clip=None, frame_indices=None):
        if image_type == 'image':
            ...
            if fn.endswith('/'):
                ...
                frames = read_frames_decord(fn, num_frames=max_num_frames, min_num_frames=min_num_frames,
                                            client=self.client, sample=sample, clip=clip, frame_indices=frame_indices)
            return frames
