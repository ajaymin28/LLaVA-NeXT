...
[] - instead of taking all the frames from start to end taking only mix max of annotations
...
if __name__=="__main__":
    ...
    OUTPUT_JSON_DIR = "/lustre/fs1/home/jbhol/dso/gits/OpenPVSG/data/video_llava_annotations_v8/"
