...
CUDA_VISIBLE_DEVICES=0 python evaluate_AG_v5_3_onevision_finetune_random.py \
    ...
    --output_dir /groups/sernam/VideoSGG/results/llava_video/11.03_17:51-llavaov-AG-v5_3_split00_olora256_512_full_visiontowerlr_2e-6_subset5000/ --conv-mode qwen_2 \
    --subset 5000 \