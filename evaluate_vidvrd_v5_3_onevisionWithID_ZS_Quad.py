...
from utils.utilities import pre_clean_prediction_data_onevision_v7,pre_clean_prediction_data_onevision_v14_vrd
...
if __name__=="__main__":
    ...
    for val_id_idx, val_id in enumerate(val_ids):
        ...
        for frame_block_index, overall_annot in enumerate(overall_annotations):
            ...
            outputs = pre_clean_prediction_data_onevision_v14_vrd(outputs_unclean["triplets"],fileData=[file,Block_frame_ids],remove_entity_idx=True)
