...
wget -O "$OUTPUT_DIR/adapter_model.bin" $DOWN_MODEL_PATH/adapter_model.safetensors
wget -O "$OUTPUT_DIR/adapter_model.safetensors" $DOWN_MODEL_PATH/adapter_model.safetensors
...
#https://huggingface.co/ajaymin28/vl-sg-vrd-loras/resolve/main/llavanext-google_siglip-so400m-patch14-384-Qwen_Qwen2-7B-Instruct-VRD_v5_3_split03_all_mm_tune_olora256_512_llm/README.md