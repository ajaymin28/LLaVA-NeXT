...
# DATA_YAML="/home/jbhol/dso/gits/LLaVA-NeXT/scripts/video/train/exp.yaml" # e.g exp.yaml
DATA_YAML="/home/jbhol/dso/gits/LLaVA-NeXT/scripts/video/train/exp_p023.yaml"
...
export WANDB_PROJECT="LLAVAVideoQwen_SGG_AGLora"
...
MID_RUN_NAME="llavaqwen2-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-AG_v5_3_split023_all_mm_tune_olora256_512_llm"
...
deepspeed --master_port 30000 \
    ...
    --output_dir /home/jbhol/dso/gits/LLaVA-NeXT/work_dirs/llavaqwen2/$MID_RUN_NAME \
    --num_train_epochs 1 \
